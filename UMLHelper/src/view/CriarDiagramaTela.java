...
public class CriarDiagramaTela extends BasicGraphEditor
{
	...
	public CriarDiagramaTela(String appTitle, mxGraphComponent component)
	{
		...
		shapesPalette
				.addTemplate("Rectangle",
						...
						null, 160, 120, "");
		shapesPalette
				.addTemplate("Rounded Rectangle",
						new ImageIcon(
								CriarDiagramaTela.class
										.getResource("/images/rounded.png")),
						"rounded=1", 160, 120, "");
		shapesPalette
				.addTemplate("Double Rectangle",
						new ImageIcon(
								CriarDiagramaTela.class
		...
		shapesPalette
				.addEdgeTemplate("Vertical Connector",
						...
						"vertical", 100, 100, "");
		shapesPalette
				.addEdgeTemplate("Entity Relation",
						new ImageIcon(
								CriarDiagramaTela.class
										.getResource("/images/entity.png")),
						"entity", 100, 100, "");
		shapesPalette
				.addEdgeTemplate("Arrow",
						new ImageIcon(
								CriarDiagramaTela.class
	...
	public static class CustomGraphComponent extends mxGraphComponent
	{
		...
		public CustomGraphComponent(mxGraph graph)
		{
			...
			Document doc = mxUtils.loadDocument(CriarDiagramaTela.class.getResource(
