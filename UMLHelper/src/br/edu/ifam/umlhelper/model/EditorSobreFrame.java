...
public class EditorSobreFrame extends JDialog
{
	...
	public EditorSobreFrame(Frame owner)
	{
		...
		// Adds title
		JLabel titleLabel = new JLabel("Sobre UMLHelper");
		...
		JLabel subtitleLabel = new JLabel(
				"Para mais informações acesse: https://github.com/Antonnyx/TCCI/tree/development/UMLHelper");
		...
		content.add(new JLabel("UMLHelper - Um software de Diagramas de Caso de Uso com foco em acessibilidade para surdos"));
