...
public class Paletas extends JPanel{
    ...
    private ImageIcon naoTemIcon = new ImageIcon(Paletas.class.getResource("/br/edu/ifam/umlhelper/images/nao_ter.png"));
    private ImageIcon libras = new ImageIcon(Paletas.class.getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"));
    private Action tocarVideoAction;
    ...
    public void addTemplate(final String name, ImageIcon icon, mxCell cell)
    {
            ...
            entry.addMouseListener(new MouseListener()
            {
                    ...
                    public void mouseReleased(MouseEvent e)
                    {
                        ...
                        if(e.isPopupTrigger())
                        {
                            tocarVideoAction = new AbstractAction(name){
                            @Override
                            public void actionPerformed(ActionEvent e) {
                                String elemento = "";
                                switch(name){
                                    case "Ator":
                                        elemento = "src\\videos\\videoAtor.mp4";
                                        break;
                                    case "Agregação":
                                        elemento = "src\\videos\\videoAgregacao.mp4";
                                        break;
                                    case "Caso de Uso":
                                        elemento = "src\\videos\\videoCasoUso.mp4";
                                        break;
                                    case "Incluir":
                                        elemento = "src\\videos\\videoIncluir.mp4";
                                        break;
                                    case "Estender":
                                        elemento = "src\\videos\\videoEstender.mp4";
                                        break;
                                    case "Generalizar":
                                        elemento = "src\\videos\\videoGeneralizacao.mp4";
                                        break;
                                    case "Subsistema":
                                        elemento = "src\\videos\\videoSubsistema.mp4";
                                        break;
                                    case "Video":
                                        elemento = "src\\videos\\video.mp4";
                                        break;
                                    default:
                                        elemento = "src\\videos\\video1.mp4";
                                        break;                                       
                                }
                                
                                Player2.setInternalVideoPath(elemento);
                                Player2.main(null);
                            }
                            ...
                            JLabel iconLabel = new JLabel(libras);
                            JMenuItem jMenu = new JMenuItem();
                            jMenu.setIcon(libras);
                            jMenu.setAction(tocarVideoAction);
                            popUp.add(jMenu);
                            
                            popUp.show(entry, pt.x, pt.y);
                            e.consume();
                        }
