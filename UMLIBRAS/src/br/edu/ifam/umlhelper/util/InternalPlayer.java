...
public class InternalPlayer {
  ...
  private static void initAndShowGUI(String path) {
    ...
    frame.setIconImage(Toolkit.getDefaultToolkit().getImage(InternalPlayer.class.getResource("/br/edu/ifam/umlhelper/images/icon_libras.png")));
...
class SceneGenerator2 {    
    ...
    public SceneGenerator2(String videoPath){
  ...
  public Scene createScene() throws URISyntaxException {
   ...
   final Media m = new Media(InternalPlayer.class.getResourceAsStream(videoPath).toString());
   ...
   mp.setOnReady(new Runnable() {
        ...
        public void run() {
            ...
            videoStatus = "Pausar";
            play.setGraphic(stop1);
            if(InternalPlayer.frame.getWidth() != m.getWidth()+20 && InternalPlayer.frame.getHeight()!= (m.getHeight()+170)){
                InternalPlayer.frame.setBounds(0, 0, m.getWidth()+20, m.getHeight()+170);
                InternalPlayer.frame.setLocationRelativeTo(null);
                progress.setPrefWidth(InternalPlayer.frame.getWidth());
            }
