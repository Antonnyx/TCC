...
import br.edu.ifam.umlhelper.util.InternalPlayer;
...
public class TelaCriarDiagramaCasoDeUso extends javax.swing.JFrame {
    ...
    private String tituloTela = "UMLibras";
    ...
    public TelaCriarDiagramaCasoDeUso() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/br/edu/ifam/umlhelper/images/uml_2.png")));
    ...
    private void initComponents() {
        ...
        jMenuCasoDeUso = new javax.swing.JMenu();
        jMenuItemAtor = new javax.swing.JMenuItem();
        jMenuItemCasoDeUso = new javax.swing.JMenuItem();
        jMenuItemAgregacao = new javax.swing.JMenuItem();
        jMenuItemIncluir = new javax.swing.JMenuItem();
        jMenuItemEstender = new javax.swing.JMenuItem();
        jMenuItemGeneralizar = new javax.swing.JMenuItem();
        jMenuItemSubsistema = new javax.swing.JMenuItem();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(59, 59, 59)
                .addComponent(labelIcon, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jMenuSobre.setText("Sobre UMLibras");
        ...
        jMenuCasoDeUso.setText("Caso de Uso");

        jMenuItemAtor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        ...
        jMenuCasoDeUso.add(jMenuItemAtor);

        jMenuItemCasoDeUso.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        jMenuItemCasoDeUso.setText("Caso de Uso");
        jMenuItemCasoDeUso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemCasoDeUsoActionPerformed(evt);
            }
        });
        jMenuCasoDeUso.add(jMenuItemCasoDeUso);

        jMenuItemAgregacao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        jMenuItemAgregacao.setText("Agregação");
        jMenuItemAgregacao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemAgregacaoActionPerformed(evt);
            }
        });
        jMenuCasoDeUso.add(jMenuItemAgregacao);

        jMenuItemIncluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        ...
        jMenuCasoDeUso.add(jMenuItemIncluir);

        jMenuItemEstender.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        jMenuItemEstender.setText("Estender");
        jMenuItemEstender.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemEstenderActionPerformed(evt);
            }
        });
        jMenuCasoDeUso.add(jMenuItemEstender);

        jMenuItemGeneralizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        jMenuItemGeneralizar.setText("Generalização");
        jMenuItemGeneralizar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemGeneralizarActionPerformed(evt);
            }
        });
        jMenuCasoDeUso.add(jMenuItemGeneralizar);

        jMenuItemSubsistema.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        jMenuItemSubsistema.setText("Subsistema");
        jMenuItemSubsistema.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemSubsistemaActionPerformed(evt);
            }
        });
        jMenuCasoDeUso.add(jMenuItemSubsistema);

        jMenuItemVideo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifam/umlhelper/images/icon_libras_small.png"))); // NOI18N
        ...
        jMenuCasoDeUso.add(jMenuItemVideo);

        jMenuAjuda.add(jMenuCasoDeUso);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(painelPaletas, javax.swing.GroupLayout.PREFERRED_SIZE, 338, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void jMenuItemAtorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemAtorActionPerformed
        Player2.setVideoPath("src\\videos\\videoAtor.mp4");
        Player2.main(null);
    }//GEN-LAST:event_jMenuItemAtorActionPerformed

    private void jMenuItemCasoDeUsoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCasoDeUsoActionPerformed
        Player2.setInternalVideoPath("src\\videos\\videoCasoUso.mp4");
        Player2.main(null);
    }//GEN-LAST:event_jMenuItemCasoDeUsoActionPerformed

    private void jMenuItemAgregacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemAgregacaoActionPerformed
        Player2.setInternalVideoPath("src\\videos\\videoAgregacao.mp4");
        Player2.main(null);
    }//GEN-LAST:event_jMenuItemAgregacaoActionPerformed
    ...
    private void jMenuItemIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemIncluirActionPerformed
        Player2.setInternalVideoPath("src\\videos\\videoIncluir.mp4");
        Player2.main(null);
    }//GEN-LAST:event_jMenuItemIncluirActionPerformed

    private void jMenuItemEstenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemEstenderActionPerformed
        Player2.setInternalVideoPath("src\\videos\\videoEstender.mp4");
        Player2.main(null);
    }//GEN-LAST:event_jMenuItemEstenderActionPerformed

    private void jMenuItemGeneralizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemGeneralizarActionPerformed
        Player2.setInternalVideoPath("src\\videos\\videoGeneralizacao.mp4");
        Player2.main(null);
    }//GEN-LAST:event_jMenuItemGeneralizarActionPerformed

    private void jMenuItemSubsistemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSubsistemaActionPerformed
        Player2.setInternalVideoPath("src\\videos\\videoSubsistema.mp4");
        Player2.main(null);
    }//GEN-LAST:event_jMenuItemSubsistemaActionPerformed

    private void jMenuItemVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemVideoActionPerformed
        Player2.setInternalVideoPath("src\\videos\\video.mp4");
        Player2.main(null);
    ...
    private javax.swing.JMenu jMenuCasoDeUso;
    ...
    private javax.swing.JMenuItem jMenuItemAgregacao;
    private javax.swing.JMenuItem jMenuItemAtor;
    private javax.swing.JMenuItem jMenuItemCasoDeUso;
    private javax.swing.JMenuItem jMenuItemEstender;
    private javax.swing.JMenuItem jMenuItemGeneralizar;
    private javax.swing.JMenuItem jMenuItemIncluir;
    private javax.swing.JMenuItem jMenuItemSubsistema;
